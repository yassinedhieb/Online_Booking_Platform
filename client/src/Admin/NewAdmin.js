...
class NewAdminRegister extends React.Component {
  state = {
    name: "",
    last_name: "",
    email: "",
  ...
  componentDidUpdate(prevProps){
      ...
      if(error!==prevProps.error){
          ...
          if(error.id==='ADMIN_REGISTER_FAIL'){
...
export default connect(mapStateToProps,{registerAdmin,clearErrors})(NewAdminRegister)